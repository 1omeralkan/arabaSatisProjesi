                ...
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                          <g id="Icon" transform="translate(27.000000, 15.000000)">
                            ...
                            <span class="app-brand-text demo text-body fw-bolder">CarHeaven</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <h4 class="mb-2">Welcome to CarHeaven 👋</h4>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <button type="submit" class="btn btn-primary d-grid w-100">Giriş Yap</button>
                        </div>
                    </form>

                    <p class="text-center">
                        <span>Platformda yeni misin?</span>
