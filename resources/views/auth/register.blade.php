            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2">Araba Satışları Burada</h4>
                    <p class="mb-4">Dilediğiniz şekilde araç satış ve alımı <yapabilirsiniz class=""></yapabilirsiniz></p>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{route('register')}}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="email" name="email" placeholder="Mailinizi giriniz." />
                        </div>
                        ...
                        <div class="mb-3 form-password-toggle">
                            <label class="form-label" for="passwordConfirmation">Şifre Onayı :</label>
                            <div class="input-group input-group-merge">
                                <input
                                    type="password"
                        ...
                        <div class="mb-3">
                            <label for="referance_code" class="form-label">Referans Kodunuz :</label>
                            <input
                                type="text"
                                class="form-control"
                                id="referance_code"
                    ...
                    <p class="text-center">
                        <span>Hesabın zaten var mı?</span>
                        <a href="{{route('login')}}">
